...
**Confirmed absent.** `deliverytype` describes the deal type, not the prerequisites to reach one. Now also carries ADD-014's surviving requirement: prerequisites with buyer-specific status.
